...
### [ ] C1 — Add ownership check to queue cancel/update
...
### [ ] C2 — Eliminate TOCTOU symlink race in scoped file I/O
...
### [ ] H1 — Stop returning stack traces in error responses
...
### [ ] H2 — Per-event authorization in `/runner` Socket.IO namespace
...
### [ ] H3 — Shorten forwarded-identity replay window + add nonce cache
...
### [ ] H4 — Pin `socket.io` to an exact version
...
### [ ] H5 — TTL & rotation for runner invite tokens and bearer tokens
...
### [ ] M2 — SSRF guard for MCP OAuth fetch targets
...
### [ ] M6 — Constrain `/api/browse/list` on Windows
...
### [ ] L1 — Sanitize markdown rendering
...
### [ ] L2 — Replace `"@funny/*": "*"` with `"workspace:*"`
...
### [ ] L4 — Reject branch names starting with `-`
