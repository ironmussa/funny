...
It ships as a Bun workspaces monorepo with **20 packages** under `packages/*`, a CLI entrypoint (`bin/funny.js`), and an optional Tauri desktop shell (`src-tauri/`).
...
| Page                                                                                   | What it covers                                                                                                                                       |
| -------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| [architecture/overview.md](./architecture/overview.md)                                 | Full package map (all 20 packages), what's live app vs. standalone service vs. experimental, deployment topology                                     |
...
| [architecture/client-platform-boundary.md](./architecture/client-platform-boundary.md) | Renderer-independent client services, composition flow, store inventory, and intentionally web-only areas                                            |
