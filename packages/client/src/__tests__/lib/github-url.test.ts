...
describe('github-url', () => {
  ...
  test('githubBranchUrl builds branch page URLs and preserves branch slashes', () => {
    expect(githubBranchUrl('https://github.com/acme/funny', 'feat/video player')).toBe(
      'https://github.com/acme/funny/tree/feat/video%20player',
    );
  });
