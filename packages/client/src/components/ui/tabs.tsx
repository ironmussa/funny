...
function TabsContent({
  ...
  return (
    <TabsPrimitive.Content
      ref={ref}
      className={cn(
        'focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-ring/50',
        className,
      )}
      {...props}
    />
