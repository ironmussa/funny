...
/**
 * Static registry models plus runtime-discovered Pi and Cursor catalogs,
 * grouped for the prompt model picker and General Settings visibility UI.
 */
export function useUnifiedPromptModelGroups() {
  ...
  return useCursorPromptModels(piUnifiedModelGroups);
}
