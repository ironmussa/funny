 ...
 * @domain layer: domain
 *
 * Pure types for the scheduler core. No DB, no HTTP, no
...
/** Snapshot of an in-flight pipeline run as the scheduler sees it. */
...
export interface EligibilityInput {
  ...
  candidates: Thread[];
  /** Threads currently executing (a row exists in `scheduler_runs`). */
...
export type SchedulerErrorCode = 'INVALID_INPUT';
