/**
 * Phase 0 smoke test for the scheduler integration.
 *
 * Goal: prove that the foundational primitives the scheduler will
...
describe('scheduler smoke — runPipeline standalone', () => {
