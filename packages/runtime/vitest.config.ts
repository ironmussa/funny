...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@funny/shared/runner-v2/common': path.join(
        shared,
        'generated/runner-v2/runner/v2/common_pb.ts',
      ),
      '@funny/shared/runner-v2/control': path.join(
        shared,
        'generated/runner-v2/runner/v2/control_pb.ts',
      ),
      '@funny/shared/runner-v2/events': path.join(
        shared,
        'generated/runner-v2/runner/v2/events_pb.ts',
      ),
      '@funny/shared/runner-v2/operations': path.join(
        shared,
        'generated/runner-v2/runner/v2/operations_pb.ts',
      ),
