/**
 * Tiny console-backed logger satisfying `SchedulerLogger`.
 *
 * Two output formats:
 ...
 * logger that conforms to `SchedulerLogger` — keep the dependency
 * surface minimal here so the binary stays portable.
 */

import type { SchedulerLogger } from './service.js';
...
export function createConsoleLogger(opts: ConsoleLoggerOptions = {}): SchedulerLogger {
