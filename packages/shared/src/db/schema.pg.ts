 ...
 *
 * Mirrors schema.sqlite.ts 1-for-1 using pgTable() definitions.
 * Column names, table names, defaults, and foreign keys are identical
...
export const threads = pgTable('threads', {
  ...
  initSlashCommands: text('init_slash_commands'),
...
export const pendingPermissionRequests = pgTable(
...
export const runnerOperationIdempotency = pgTable(
...
export const runnerEventReceipts = pgTable(
